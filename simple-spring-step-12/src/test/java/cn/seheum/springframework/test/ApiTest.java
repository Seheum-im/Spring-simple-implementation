...
import cn.seheum.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor;
...
import cn.seheum.springframework.test.bean.UserServiceBeforeAdvice;
import cn.seheum.springframework.test.bean.UserServiceInterceptor;
...
public class ApiTest {
    ...
    public void init() {
        ...
        advisedSupport.setMethodMatcher(new AspectJExpressionPointcut("execution(* cn.seheum.springframework.test.bean.IUserService.*(..))"));
    }
    ...
    public void test_advisor() {
        ...
        advisor.setExpression("execution(* cn.seheum.springframework.test.bean.IUserService.*(..))");
    ...
    public void test_proxy_method() {
        ...
        IUserService proxy = (IUserService) Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), targetObj.getClass().getInterfaces(), new InvocationHandler() {
            // 方法匹配器
            MethodMatcher methodMatcher = new AspectJExpressionPointcut("execution(* cn.seheum.springframework.test.bean.IUserService.*(..))");
